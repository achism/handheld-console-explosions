...
> [!NOTE]
> All image files are adapted from the original "Console Explosions" artwork created by Pierre Roussel. He can be found [here](https://www.instagram.com/_itspear/). Original art files can be found [here](https://www.artstation.com/pierreroussel/albums/8482338).
